#ifndef __51kbyQVPDkrPJnyVpDcu4F_h__
#define __51kbyQVPDkrPJnyVpDcu4F_h__
...
/* Type Definitions */
#ifndef struct_sOQHS9eKMEy3LTM6rHnwHAG
#define struct_sOQHS9eKMEy3LTM6rHnwHAG

struct sOQHS9eKMEy3LTM6rHnwHAG
{
  real_T dimModes;
  real_T dims;
  real_T dType;
...
#endif                                 /*struct_sOQHS9eKMEy3LTM6rHnwHAG*/

#ifndef typedef_sOQHS9eKMEy3LTM6rHnwHAG
#define typedef_sOQHS9eKMEy3LTM6rHnwHAG

typedef struct sOQHS9eKMEy3LTM6rHnwHAG sOQHS9eKMEy3LTM6rHnwHAG;

#endif                                 /*typedef_sOQHS9eKMEy3LTM6rHnwHAG*/
...
#ifndef struct_sRfajKYYij9gfFHpNsnCPOF
#define struct_sRfajKYYij9gfFHpNsnCPOF

struct sRfajKYYij9gfFHpNsnCPOF
{
...
#endif                                 /*struct_sRfajKYYij9gfFHpNsnCPOF*/

#ifndef typedef_comm_CarrierSynchronizer
#define typedef_comm_CarrierSynchronizer

typedef struct sRfajKYYij9gfFHpNsnCPOF comm_CarrierSynchronizer;

#endif                                 /*typedef_comm_CarrierSynchronizer*/

#ifndef typedef_InstanceStruct_51kbyQVPDkrPJnyVpDcu4F
#define typedef_InstanceStruct_51kbyQVPDkrPJnyVpDcu4F
...
#endif                                 /*typedef_InstanceStruct_51kbyQVPDkrPJnyVpDcu4F*/
...
extern void method_dispatcher_51kbyQVPDkrPJnyVpDcu4F(SimStruct *S, int_T method,
  void* data);
extern int autoInfer_dispatcher_51kbyQVPDkrPJnyVpDcu4F(mxArray *lhs[], const
  char* commandName);
